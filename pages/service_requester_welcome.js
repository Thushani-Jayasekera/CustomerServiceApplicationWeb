...
import welcomeImage from '../images/welcomePage.jpg'
...
const Card2 = tw(
  motion.a
)`bg-purple-500 rounded-b block max-w-xs mx-auto sm:max-w-none sm:mx-0`;
...
<br/>
        <HeaderRow >
          <Actions>
            ...
            />
            <button onClick={scrollToSection}>Search</button>
    ...
    <Container>
      ...
      <ContentWithPaddingXl>
        ...
        <HeaderRow>
          <Heading2>Select what you want to get done!</Heading2>
        </HeaderRow>
      ...
      <Columns>
        {types.map((type, index) => (
              <CardContainer2 key={index} >
                ...
                <Card2 className="group" href={`/service_requester/selectOption/${type.user_type}`}initial="rest" whileHover="hover" animate="rest">
    ...
    <HeaderRow>
          <Heading2>Our Providers!</Heading2>
        </HeaderRow>
