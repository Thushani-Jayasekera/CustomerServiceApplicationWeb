...
import { CREATE_NEW_BIDDING_JOB } from '../gql/mutation';
...
const BiddingJobPage = ({ history }) => {
  ...
  ] = useMutation(CREATE_NEW_BIDDING_JOB, {
    onCompleted: data => {
      history.push('/');
    }
  });
      ...
      <Content>
        <FormContainer>
          <div tw="mx-auto max-w-4xl">
            <h2>New Job for Providers to Bid</h2>
